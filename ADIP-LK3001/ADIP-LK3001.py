...
if __name__ == '__main__':
    ...
    try:
        ...
        index_LetterE1 = index_file_read(File_path_log_index_LetterE1)
        if index_LetterE1 != '':
            log_index_flag_LetterE1 = True

        index_LetterE2 = index_file_read(File_path_log_index_LetterE2)
        if index_LetterE2 != '' and index_LetterE2 != 'Z':
            log_index_flag_LetterE2 = True

        index_LetterE3 = index_file_read(File_path_log_index_LetterE3)
