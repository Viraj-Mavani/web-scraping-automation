...
File_path_failed_CSV = BasePath + '\\OP\\ADIP-ZA1401_Failed.csv'
######### Text #########
...
File_path_log_index = BasePath + '\\Log\\ADIP-ZA1401_Log_Index.txt'
...
def individual_data():
    try:
        ...
        totRows = len(rows)
        log_print("Total " + str(totRows) + " Data Found")
        if totRows==0:
...
if __name__ == '__main__':
    ...
    try:
        ...
        number_combinations = [str(a) for a in range(10)]
        d_letter_combinations = [f'{a}{b}' for a in string.ascii_uppercase for b in string.ascii_uppercase]
        dp_letter_combinations = [f'{a}%{b}%' for a in string.ascii_uppercase for b in string.ascii_uppercase]
        ...
        tp_letter_combinations = [f'{a}%{b}%{c}%' for a in string.ascii_uppercase for b in string.ascii_uppercase for c in string.ascii_uppercase]
        ...
        if log_index_flag:
            start_index = letterCombinationsList.index(last_processed_letter) + 1
            letter_num_list = letterCombinationsList[start_index:]
        else:
            letter_num_list = letterCombinationsList
        ...
        convertCSVExcelExtended(File_path_CSV, File_path)
        et = time.time()
        log_print(f'\n{et - st}')
        os._exit(0)
